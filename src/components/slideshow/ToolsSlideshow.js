    ...
    <div className="Slideshow container mb-3">
      <Carousel variant="dark">
        <Carousel.Item>
          ...
          />
          <Carousel.Caption>
            <h5 class="text-primary">{tools[0]?.name}</h5>
            <p class="text-primary">{tools[0]?.description}</p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <img
          ...
          />
          <Carousel.Caption>
            <h5 class="text-primary">{tools[1]?.name}</h5>
            <p class="text-primary">{tools[1]?.description}</p>
          </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item>
          <img
          ...
          />
          <Carousel.Caption>
            <h5 class="text-primary">{tools[2]?.name}</h5>
            <p class="text-primary">{tools[2]?.description}</p>
          </Carousel.Caption>
        </Carousel.Item>
      </Carousel>
    </div>
